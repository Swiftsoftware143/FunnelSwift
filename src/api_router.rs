...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        // Site Config — consolidated (admin only)
        .route(
            "/api/v1/admin/site",
            get(site_handler::get_site).put(site_handler::update_site),
        )
        ...
        .route(
            ...
            post(coreswift_integration_handler::test_provider_connection),
        )
        // Canonical CoreSwift spoke endpoints (fleet standard 2026-09-20)
        .route(
